...
SymbolTable *calcInitSymbolTable() {
  ...
  stInsertFunction(st, "log10", log10);
  stInsertFunction(st, "asin", asin);
  stInsertFunction(st, "acos", acos);
  stInsertFunction(st, "atan", atan);
  stInsertFunction(st, "sinh", sinh);
  stInsertFunction(st, "cosh", cosh);
  stInsertFunction(st, "tanh", tanh);

  stInsertFunction(st, "ceil", ceil);
  stInsertFunction(st, "floor", floor);
  stInsertFunction(st, "sqrt", sqrt);
  stInsertFunction(st, "exp", exp);
  stInsertFunction(st, "fabs", fabs);
